        ...
        <section id="gangs" className="scroll-mt-24">
          ...
          <h3 id="gang-card-presentation" className="text-lg font-semibold text-foreground mt-6 mb-1 scroll-mt-24">
            ...
            <ol className="list-decimal pl-6 space-y-2 mt-4 marker:text-red-800">
              ...
              <li className="text-muted-foreground"><strong className="text-foreground">Edit Button:</strong> This is where you can edit the different settings of your gang: Name, Resources, Alliance etc. You can also delete you gang in this menu.</li>

-- Migration: Add unified check_permission RPC
-- Replaces get_gang_permissions with a simpler function that returns
-- { is_admin, campaign_role }. Gang ownership is checked via user_id column.

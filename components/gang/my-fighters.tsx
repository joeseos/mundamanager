...
const BACKGROUND_IMAGE_URL =
  'https://res.cloudinary.com/dle0tkpbl/image/upload/f_auto,q_auto:good,w_800,c_limit/v1732964932/light-texture-bg-sm_wqttn8.jpg';

// Add proper image sizes
const imageSizes = { mobile: '100vw', tablet: '50vw', desktop: '800px' };

export function MyFighters({
  fighters,
  positions,
  isLoading,
  error,
  ...
  const sortedFighters = useMemo(() => {
    ...
    return [...fighters].sort((a, b) => {
      ...
      const posA =
        positionMap[a.id] !== undefined
          ? positionMap[a.id]
          : Number.MAX_SAFE_INTEGER;
      const posB =
        positionMap[b.id] !== undefined
          ? positionMap[b.id]
          : Number.MAX_SAFE_INTEGER;
      return posA - posB;
    });
  ...
  const validFighters = fighters.filter(
    (fighter) =>

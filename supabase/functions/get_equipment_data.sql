DROP FUNCTION IF EXISTS get_equipment_data(uuid, text, uuid, boolean);
DROP FUNCTION IF EXISTS get_equipment_data(uuid, text, uuid, boolean, boolean);
DROP FUNCTION IF EXISTS get_equipment_data(uuid,text,uuid,boolean,boolean,uuid,uuid);
DROP FUNCTION IF EXISTS get_equipment_data(uuid,text,uuid,boolean,boolean,uuid,uuid,uuid);
DROP FUNCTION IF EXISTS get_equipment_data(uuid,text,uuid,boolean,boolean,uuid,uuid,uuid,boolean);

-- Create the new function with simplified LATERAL join and gang_id parameter
CREATE OR REPLACE FUNCTION get_equipment_data(

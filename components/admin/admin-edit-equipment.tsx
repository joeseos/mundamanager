                ...
                <div className="col-span-3">
                  ...
                  >
                    ...
                    {filteredFighterTypes
                      ...
                      .map((ft) => {
                        const specialisationText = ft.fighter_variant ? ` - ${ft.fighter_variant}` : '';
                        return (
                    ...
                    {selectedFighterTypes.map((ftId) => {
                      ...
                      return (
                        <div
                          ...
                          className="flex items-center gap-1 px-2 py-1 rounded-full text-sm bg-muted"
                        >
                          <span>{`${ft.gang_type} - ${ft.fighter_type} (${ft.fighter_subtypes?.join(', ')})${ft.fighter_variant ? ` - ${ft.fighter_variant}` : ''}`}</span>
                          <button
                            type="button"

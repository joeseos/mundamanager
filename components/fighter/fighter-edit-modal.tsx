...
export function EditFighterModal({
  ...
  const handleConfirm = async () => {
    try {
      ...
      console.log('selectedFighterTypeId:', selectedFighterTypeId);
      console.log('selectedSubTypeId:', selectedSubTypeId);
      console.log('hasExplicitlySelectedType:', hasExplicitlySelectedType);
      ...
      console.log('selectedFighterType (initial):', selectedFighterType);
      ...
      if (selectedSubTypeId) {
        console.log('Looking for sub-type with ID:', selectedSubTypeId);
        console.log('Available sub-types by fighter type:', subTypesByFighterType);
        ...
        console.log('foundSubType:', foundSubType);
        ...
        if (foundSubType) {
          ...
          if (foundSubType && (foundSubType as SubTypeWithFighterTypeId).fighter_type_id) {
            console.log('Sub-type fighter_type_id:', (foundSubType as SubTypeWithFighterTypeId).fighter_type_id);
            ...
            console.log('selectedFighterType (after sub-type lookup):', selectedFighterType);
          }
        }
      }
      ...
      console.log('selectedFighterType (final):', selectedFighterType);
      console.log('shouldUpdateFighterType:', shouldUpdateFighterType);

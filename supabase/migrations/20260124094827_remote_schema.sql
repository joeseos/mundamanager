...
ALTER TYPE "public"."alignment" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "private"."is_arb"("campaign_id_param" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    AS $$
  SELECT EXISTS (
    SELECT 1 
...
ALTER FUNCTION "private"."is_arb"("campaign_id_param" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."add_fighter_injury"("in_fighter_id" "uuid", "in_injury_type_id" "uuid", "in_user_id" "uuid", "in_target_equipment_id" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("result" "json")
...
ALTER FUNCTION "public"."add_fighter_injury"("in_fighter_id" "uuid", "in_injury_type_id" "uuid", "in_user_id" "uuid", "in_target_equipment_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."add_vehicle_effect"("in_vehicle_id" "uuid", "in_fighter_effect_type_id" "uuid", "in_user_id" "uuid", "in_fighter_effect_category_id" "uuid" DEFAULT NULL::"uuid") RETURNS "json"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'auth', 'private'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."add_vehicle_effect"("in_vehicle_id" "uuid", "in_fighter_effect_type_id" "uuid", "in_user_id" "uuid", "in_fighter_effect_category_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."assign_crew_to_vehicle"("p_vehicle_id" "uuid", "p_fighter_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    old_vehicle jsonb;
...
ALTER FUNCTION "public"."assign_crew_to_vehicle"("p_vehicle_id" "uuid", "p_fighter_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."fighter_logs"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    gang_id_val UUID;
...
ALTER FUNCTION "public"."fighter_logs"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."gang_logs"("p_gang_id" "uuid", "p_action_type" "text", "p_description" "text", "p_fighter_id" "uuid" DEFAULT NULL::"uuid", "p_vehicle_id" "uuid" DEFAULT NULL::"uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    log_id UUID;
...
ALTER FUNCTION "public"."get_add_fighter_details"("p_gang_type_id" "uuid", "p_gang_affiliation_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_available_skills"("fighter_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_equipment_data"("gang_type_id" "uuid" DEFAULT NULL::"uuid", "equipment_category" "text" DEFAULT NULL::"text", "fighter_type_id" "uuid" DEFAULT NULL::"uuid", "fighter_type_equipment" boolean DEFAULT NULL::boolean, "equipment_tradingpost" boolean DEFAULT NULL::boolean, "fighter_id" "uuid" DEFAULT NULL::"uuid", "only_equipment_id" "uuid" DEFAULT NULL::"uuid", "gang_id" "uuid" DEFAULT NULL::"uuid", "fighters_tradingpost_only" boolean DEFAULT NULL::boolean) RETURNS TABLE("id" "uuid", "equipment_name" "text", "availability" "text", "base_cost" numeric, "discounted_cost" numeric, "adjusted_cost" numeric, "equipment_category" "text", "equipment_type" "text", "created_at" timestamp with time zone, "fighter_type_equipment" boolean, "equipment_tradingpost" boolean, "is_custom" boolean, "weapon_profiles" "jsonb", "vehicle_upgrade_slot" "text", "grants_equipment" "jsonb", "is_editable" boolean)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    AS $_$
    -- Regular equipment
    SELECT DISTINCT
...
ALTER FUNCTION "public"."get_equipment_data"("gang_type_id" "uuid", "equipment_category" "text", "fighter_type_id" "uuid", "fighter_type_equipment" boolean, "equipment_tradingpost" boolean, "fighter_id" "uuid", "only_equipment_id" "uuid", "gang_id" "uuid", "fighters_tradingpost_only" boolean) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_equipment_with_discounts"("gang_type_id" "uuid" DEFAULT NULL::"uuid", "equipment_category" "text" DEFAULT NULL::"text", "fighter_type_id" "uuid" DEFAULT NULL::"uuid", "fighter_type_equipment" boolean DEFAULT NULL::boolean, "equipment_tradingpost" boolean DEFAULT NULL::boolean, "fighter_id" "uuid" DEFAULT NULL::"uuid", "only_equipment_id" "uuid" DEFAULT NULL::"uuid", "gang_id" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("id" "uuid", "equipment_name" "text", "availability" "text", "base_cost" numeric, "discounted_cost" numeric, "adjusted_cost" numeric, "equipment_category" "text", "equipment_type" "text", "created_at" timestamp with time zone, "fighter_type_equipment" boolean, "equipment_tradingpost" boolean, "is_custom" boolean, "weapon_profiles" "jsonb", "vehicle_upgrade_slot" "text", "grants_equipment" "jsonb", "is_editable" boolean)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    AS $_$
    -- Regular equipment
    SELECT DISTINCT
...
ALTER FUNCTION "public"."get_equipment_with_discounts"("gang_type_id" "uuid", "equipment_category" "text", "fighter_type_id" "uuid", "fighter_type_equipment" boolean, "equipment_tradingpost" boolean, "fighter_id" "uuid", "only_equipment_id" "uuid", "gang_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_fighter_available_advancements"("fighter_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_gang_details"("p_gang_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_gang_permissions"("p_user_id" "uuid", "p_gang_id" "uuid") RETURNS "json"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_gang_permissions"("p_user_id" "uuid", "p_gang_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."notify_campaign_member_added"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."notify_campaign_member_added"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."notify_friend_request_sent"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."notify_friend_request_sent"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."notify_gang_invite"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
   gang_name_var TEXT;
...
ALTER FUNCTION "public"."notify_gang_invite"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."repair_vehicle_damage"("damage_ids" "uuid"[], "repair_cost" integer, "in_user_id" "uuid") RETURNS "json"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'auth', 'private'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."repair_vehicle_damage"("damage_ids" "uuid"[], "repair_cost" integer, "in_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."repair_vehicle_damage"("damage_id" "uuid", "repair_cost" integer, "in_user_id" "uuid") RETURNS "json"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'auth', 'private'
    AS $$
DECLARE
...
BEGIN
    -- Parameter validation
    IF damage_id IS NULL THEN
        RAISE EXCEPTION 'damage_id must be provided';
    END IF;
    ...
    -- Get effect details and related info
    SELECT 
        fe.effect_name,
        fe.vehicle_id
    INTO 
    ...
    -- Delete the damage effect
    DELETE FROM fighter_effects WHERE id = damage_id;
    
    -- Return info about the repair
    RETURN json_build_object(
        'damage_id', damage_id,
        'damage_name', v_damage_name,
        'repair_cost', repair_cost,
        'gang_id', v_gang_id,
...
ALTER FUNCTION "public"."repair_vehicle_damage"("damage_id" "uuid", "repair_cost" integer, "in_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."safe_to_numeric"("v" "text") RETURNS numeric
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."vehicle_logs"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    vehicle_name TEXT;
...
ALTER FUNCTION "public"."vehicle_logs"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."campaign_allegiances" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."campaign_allegiances" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."campaign_battles" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "attacker_id" "uuid",
    "defender_id" "uuid",
...
ALTER TABLE "public"."campaign_battles" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."campaign_gangs" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "campaign_id" "uuid",
...
ALTER TABLE "public"."campaign_gangs" OWNER TO "postgres";
...
ALTER TABLE "public"."campaign_territories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."campaign_triumphs" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "triumph" "text",
    "criteria" "text",
...
ALTER TABLE "public"."campaign_triumphs" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."campaign_type_allegiances" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."campaign_type_allegiances" OWNER TO "postgres";
...
ALTER TABLE "public"."custom_equipment" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."custom_fighter_types" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
    "fighter_type" "text",
...
ALTER TABLE "public"."custom_fighter_types" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."custom_shared" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
...
ALTER TABLE "public"."custom_shared" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."custom_territories" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "territory_name" "text",
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."custom_territories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."custom_weapon_profiles" (
...
ALTER TABLE "public"."custom_weapon_profiles" OWNER TO "postgres";
...
ALTER TABLE "public"."equipment_availability" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."equipment_discounts" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "equipment_id" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."equipment_discounts" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."exotic_beasts" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "fighter_type_id" "uuid",
    "equipment_id" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."exotic_beasts" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_classes" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "class_name" "text"
);
...
ALTER TABLE "public"."fighter_classes" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_defaults" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "fighter_type_id" "uuid",
    "equipment_id" "uuid",
...
ALTER TABLE "public"."fighter_defaults" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_effect_categories" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "category_name" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone
...
ALTER TABLE "public"."fighter_effect_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_effect_injuries" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
...
ALTER TABLE "public"."fighter_effect_injuries" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_effect_modifiers" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "stat_name" "text",
    "fighter_effect_id" "uuid",
...
ALTER TABLE "public"."fighter_effect_modifiers" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_effect_skills" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
    "fighter_effect_id" "uuid",
...
ALTER TABLE "public"."fighter_effect_skills" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_effect_type_modifiers" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."fighter_effect_type_modifiers" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_effect_types" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "effect_name" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
...
ALTER TABLE "public"."fighter_effect_types" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_effects" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "effect_name" "text",
    "fighter_id" "uuid",
    "fighter_effect_type_id" "uuid",
...
ALTER TABLE "public"."fighter_effects" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_equipment" (
    "equipment_id" "uuid",
    "fighter_id" "uuid",
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."fighter_equipment" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_equipment_selections" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "fighter_type_id" "uuid",
...
ALTER TABLE "public"."fighter_equipment_selections" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."fighter_equipment_tradingpost" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "fighter_type_id" "uuid",
...
ALTER TABLE "public"."fighter_equipment_tradingpost" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_exotic_beasts" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."fighter_exotic_beasts" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_gang_legacy" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
    "name" "text",
...
ALTER TABLE "public"."fighter_gang_legacy" OWNER TO "postgres";
...
ALTER TABLE "public"."fighter_injuries" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_skills" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "fighter_id" "uuid",
    "updated_at" timestamp with time zone,
...
ALTER TABLE "public"."fighter_skills" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_sub_types" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "sub_type_name" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone
...
ALTER TABLE "public"."fighter_sub_types" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_type_equipment" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "equipment_id" "uuid",
    "fighter_type_id" "uuid",
...
ALTER TABLE "public"."fighter_type_equipment" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_type_gang_cost" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
    "fighter_type_id" "uuid",
...
ALTER TABLE "public"."fighter_type_gang_cost" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_type_gang_legacies" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
    "fighter_type_id" "uuid",
...
ALTER TABLE "public"."fighter_type_gang_legacies" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_type_skill_access" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "fighter_type_id" "uuid",
    "skill_type_id" "uuid",
...
ALTER TABLE "public"."fighter_type_skill_access" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."fighter_types" (
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "fighter_type" "text",
    "gang_type" "text",
    "cost" numeric,
...
ALTER TABLE "public"."fighter_types" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."gang_affiliation" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
    "name" "text",
...
ALTER TABLE "public"."gang_affiliation" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."gang_logs" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."gang_origin_categories" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
    "category_name" "text"
...
ALTER TABLE "public"."gang_origin_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."gang_origins" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone,
    "origin_name" "text",
...
ALTER TABLE "public"."gang_origins" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."gang_stash" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "gang_id" "uuid",
    "equipment_id" "uuid",
...
ALTER TABLE "public"."gang_stash" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."gang_types" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "gang_type" "text",
    "image_url" "text",
...
ALTER TABLE "public"."gang_types" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."gang_variant_types" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "variant" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone
...
ALTER TABLE "public"."gang_variant_types" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."trading_post_equipment" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "trading_post_type_id" "uuid",
    "equipment_id" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."trading_post_equipment" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."trading_post_types" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."trading_post_types" OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "fighter_delete_log_trigger" BEFORE DELETE ON "public"."fighters" FOR EACH ROW EXECUTE FUNCTION "public"."fighter_logs"();



CREATE OR REPLACE TRIGGER "on_gang_invite" AFTER INSERT ON "public"."campaign_gangs" FOR EACH ROW EXECUTE FUNCTION "public"."notify_gang_invite"();



CREATE OR REPLACE TRIGGER "trigger_campaign_member_notification" AFTER INSERT ON "public"."campaign_members" FOR EACH ROW EXECUTE FUNCTION "public"."notify_campaign_member_added"();



CREATE OR REPLACE TRIGGER "trigger_friend_request_notification" AFTER INSERT ON "public"."friends" FOR EACH ROW WHEN ((("new"."status")::"text" = 'pending'::"text")) EXECUTE FUNCTION "public"."notify_friend_request_sent"();



CREATE OR REPLACE TRIGGER "vehicle_log_trigger" AFTER INSERT OR DELETE OR UPDATE ON "public"."vehicles" FOR EACH ROW EXECUTE FUNCTION "public"."vehicle_logs"();
...
CREATE POLICY "Only campaign owners/arbitrators or system admin can delete cam" ON "public"."campaign_battles" FOR DELETE TO "authenticated" USING ((( SELECT "private"."is_admin"() AS "is_admin") OR ( SELECT "private"."is_arb"("campaign_battles"."campaign_id") AS "is_arb")));



CREATE POLICY "Only campaign owners/arbitrators or system admin can update cam" ON "public"."campaign_battles" FOR UPDATE TO "authenticated" USING ((( SELECT "private"."is_admin"() AS "is_admin") OR ( SELECT "private"."is_arb"("campaign_battles"."campaign_id") AS "is_arb"))) WITH CHECK ((( SELECT "private"."is_admin"() AS "is_admin") OR ( SELECT "private"."is_arb"("campaign_battles"."campaign_id") AS "is_arb")));
...
REVOKE ALL ON FUNCTION "public"."add_fighter_injury"("in_fighter_id" "uuid", "in_injury_type_id" "uuid", "in_user_id" "uuid", "in_target_equipment_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."add_fighter_injury"("in_fighter_id" "uuid", "in_injury_type_id" "uuid", "in_user_id" "uuid", "in_target_equipment_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."add_fighter_injury"("in_fighter_id" "uuid", "in_injury_type_id" "uuid", "in_user_id" "uuid", "in_target_equipment_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_fighter_injury"("in_fighter_id" "uuid", "in_injury_type_id" "uuid", "in_user_id" "uuid", "in_target_equipment_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."add_vehicle_effect"("in_vehicle_id" "uuid", "in_fighter_effect_type_id" "uuid", "in_user_id" "uuid", "in_fighter_effect_category_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."add_vehicle_effect"("in_vehicle_id" "uuid", "in_fighter_effect_type_id" "uuid", "in_user_id" "uuid", "in_fighter_effect_category_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."add_vehicle_effect"("in_vehicle_id" "uuid", "in_fighter_effect_type_id" "uuid", "in_user_id" "uuid", "in_fighter_effect_category_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_vehicle_effect"("in_vehicle_id" "uuid", "in_fighter_effect_type_id" "uuid", "in_user_id" "uuid", "in_fighter_effect_category_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."assign_crew_to_vehicle"("p_vehicle_id" "uuid", "p_fighter_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."assign_crew_to_vehicle"("p_vehicle_id" "uuid", "p_fighter_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."assign_crew_to_vehicle"("p_vehicle_id" "uuid", "p_fighter_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."fighter_logs"() TO "anon";
GRANT ALL ON FUNCTION "public"."fighter_logs"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."fighter_logs"() TO "service_role";



GRANT ALL ON FUNCTION "public"."gang_logs"("p_gang_id" "uuid", "p_action_type" "text", "p_description" "text", "p_fighter_id" "uuid", "p_vehicle_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."gang_logs"("p_gang_id" "uuid", "p_action_type" "text", "p_description" "text", "p_fighter_id" "uuid", "p_vehicle_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."gang_logs"("p_gang_id" "uuid", "p_action_type" "text", "p_description" "text", "p_fighter_id" "uuid", "p_vehicle_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_add_fighter_details"("p_gang_type_id" "uuid", "p_gang_affiliation_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_add_fighter_details"("p_gang_type_id" "uuid", "p_gang_affiliation_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_add_fighter_details"("p_gang_type_id" "uuid", "p_gang_affiliation_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_available_skills"("fighter_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_available_skills"("fighter_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_available_skills"("fighter_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_equipment_data"("gang_type_id" "uuid", "equipment_category" "text", "fighter_type_id" "uuid", "fighter_type_equipment" boolean, "equipment_tradingpost" boolean, "fighter_id" "uuid", "only_equipment_id" "uuid", "gang_id" "uuid", "fighters_tradingpost_only" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."get_equipment_data"("gang_type_id" "uuid", "equipment_category" "text", "fighter_type_id" "uuid", "fighter_type_equipment" boolean, "equipment_tradingpost" boolean, "fighter_id" "uuid", "only_equipment_id" "uuid", "gang_id" "uuid", "fighters_tradingpost_only" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_equipment_data"("gang_type_id" "uuid", "equipment_category" "text", "fighter_type_id" "uuid", "fighter_type_equipment" boolean, "equipment_tradingpost" boolean, "fighter_id" "uuid", "only_equipment_id" "uuid", "gang_id" "uuid", "fighters_tradingpost_only" boolean) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_equipment_with_discounts"("gang_type_id" "uuid", "equipment_category" "text", "fighter_type_id" "uuid", "fighter_type_equipment" boolean, "equipment_tradingpost" boolean, "fighter_id" "uuid", "only_equipment_id" "uuid", "gang_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_equipment_with_discounts"("gang_type_id" "uuid", "equipment_category" "text", "fighter_type_id" "uuid", "fighter_type_equipment" boolean, "equipment_tradingpost" boolean, "fighter_id" "uuid", "only_equipment_id" "uuid", "gang_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_equipment_with_discounts"("gang_type_id" "uuid", "equipment_category" "text", "fighter_type_id" "uuid", "fighter_type_equipment" boolean, "equipment_tradingpost" boolean, "fighter_id" "uuid", "only_equipment_id" "uuid", "gang_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_fighter_available_advancements"("fighter_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_fighter_available_advancements"("fighter_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_fighter_available_advancements"("fighter_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_fighter_types_with_cost"("p_gang_type_id" "uuid", "p_gang_affiliation_id" "uuid", "p_is_gang_addition" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."get_fighter_types_with_cost"("p_gang_type_id" "uuid", "p_gang_affiliation_id" "uuid", "p_is_gang_addition" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_fighter_types_with_cost"("p_gang_type_id" "uuid", "p_gang_affiliation_id" "uuid", "p_is_gang_addition" boolean) TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_gang_details"("p_gang_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_gang_details"("p_gang_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_gang_details"("p_gang_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_gang_details"("p_gang_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_gang_permissions"("p_user_id" "uuid", "p_gang_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_gang_permissions"("p_user_id" "uuid", "p_gang_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_gang_permissions"("p_user_id" "uuid", "p_gang_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_gang_permissions"("p_user_id" "uuid", "p_gang_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."notify_campaign_member_added"() TO "anon";
GRANT ALL ON FUNCTION "public"."notify_campaign_member_added"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."notify_campaign_member_added"() TO "service_role";



GRANT ALL ON FUNCTION "public"."notify_friend_request_sent"() TO "anon";
GRANT ALL ON FUNCTION "public"."notify_friend_request_sent"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."notify_friend_request_sent"() TO "service_role";



GRANT ALL ON FUNCTION "public"."notify_gang_invite"() TO "anon";
GRANT ALL ON FUNCTION "public"."notify_gang_invite"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."notify_gang_invite"() TO "service_role";



REVOKE ALL ON FUNCTION "public"."repair_vehicle_damage"("damage_ids" "uuid"[], "repair_cost" integer, "in_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."repair_vehicle_damage"("damage_ids" "uuid"[], "repair_cost" integer, "in_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."repair_vehicle_damage"("damage_ids" "uuid"[], "repair_cost" integer, "in_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."repair_vehicle_damage"("damage_ids" "uuid"[], "repair_cost" integer, "in_user_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."repair_vehicle_damage"("damage_id" "uuid", "repair_cost" integer, "in_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."repair_vehicle_damage"("damage_id" "uuid", "repair_cost" integer, "in_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."repair_vehicle_damage"("damage_id" "uuid", "repair_cost" integer, "in_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."repair_vehicle_damage"("damage_id" "uuid", "repair_cost" integer, "in_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."safe_to_numeric"("v" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."safe_to_numeric"("v" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."safe_to_numeric"("v" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."vehicle_logs"() TO "anon";
GRANT ALL ON FUNCTION "public"."vehicle_logs"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."vehicle_logs"() TO "service_role";
...
GRANT ALL ON TABLE "public"."campaign_allegiances" TO "anon";
GRANT ALL ON TABLE "public"."campaign_allegiances" TO "authenticated";
GRANT ALL ON TABLE "public"."campaign_allegiances" TO "service_role";



GRANT ALL ON TABLE "public"."campaign_battles" TO "anon";
GRANT ALL ON TABLE "public"."campaign_battles" TO "authenticated";
GRANT ALL ON TABLE "public"."campaign_battles" TO "service_role";



GRANT ALL ON TABLE "public"."campaign_gangs" TO "anon";
GRANT ALL ON TABLE "public"."campaign_gangs" TO "authenticated";
GRANT ALL ON TABLE "public"."campaign_gangs" TO "service_role";
...
GRANT ALL ON TABLE "public"."campaign_territories" TO "anon";
GRANT ALL ON TABLE "public"."campaign_territories" TO "authenticated";
GRANT ALL ON TABLE "public"."campaign_territories" TO "service_role";



GRANT ALL ON TABLE "public"."campaign_triumphs" TO "anon";
GRANT ALL ON TABLE "public"."campaign_triumphs" TO "authenticated";
GRANT ALL ON TABLE "public"."campaign_triumphs" TO "service_role";



GRANT ALL ON TABLE "public"."campaign_type_allegiances" TO "anon";
GRANT ALL ON TABLE "public"."campaign_type_allegiances" TO "authenticated";
GRANT ALL ON TABLE "public"."campaign_type_allegiances" TO "service_role";
...
GRANT ALL ON TABLE "public"."custom_equipment" TO "anon";
GRANT ALL ON TABLE "public"."custom_equipment" TO "authenticated";
GRANT ALL ON TABLE "public"."custom_equipment" TO "service_role";



GRANT ALL ON TABLE "public"."custom_fighter_types" TO "anon";
GRANT ALL ON TABLE "public"."custom_fighter_types" TO "authenticated";
GRANT ALL ON TABLE "public"."custom_fighter_types" TO "service_role";



GRANT ALL ON TABLE "public"."custom_shared" TO "anon";
GRANT ALL ON TABLE "public"."custom_shared" TO "authenticated";
GRANT ALL ON TABLE "public"."custom_shared" TO "service_role";



GRANT ALL ON TABLE "public"."custom_territories" TO "anon";
GRANT ALL ON TABLE "public"."custom_territories" TO "authenticated";
GRANT ALL ON TABLE "public"."custom_territories" TO "service_role";



GRANT ALL ON TABLE "public"."custom_weapon_profiles" TO "anon";
GRANT ALL ON TABLE "public"."custom_weapon_profiles" TO "authenticated";
GRANT ALL ON TABLE "public"."custom_weapon_profiles" TO "service_role";
...
GRANT ALL ON TABLE "public"."equipment_availability" TO "anon";
GRANT ALL ON TABLE "public"."equipment_availability" TO "authenticated";
GRANT ALL ON TABLE "public"."equipment_availability" TO "service_role";
...
GRANT ALL ON TABLE "public"."equipment_discounts" TO "anon";
GRANT ALL ON TABLE "public"."equipment_discounts" TO "authenticated";
GRANT ALL ON TABLE "public"."equipment_discounts" TO "service_role";



GRANT ALL ON TABLE "public"."exotic_beasts" TO "anon";
GRANT ALL ON TABLE "public"."exotic_beasts" TO "authenticated";
GRANT ALL ON TABLE "public"."exotic_beasts" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_classes" TO "anon";
GRANT ALL ON TABLE "public"."fighter_classes" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_classes" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_defaults" TO "anon";
GRANT ALL ON TABLE "public"."fighter_defaults" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_defaults" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_effect_categories" TO "anon";
GRANT ALL ON TABLE "public"."fighter_effect_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_effect_categories" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_effect_injuries" TO "anon";
GRANT ALL ON TABLE "public"."fighter_effect_injuries" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_effect_injuries" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_effect_modifiers" TO "anon";
GRANT ALL ON TABLE "public"."fighter_effect_modifiers" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_effect_modifiers" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_effect_skills" TO "anon";
GRANT ALL ON TABLE "public"."fighter_effect_skills" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_effect_skills" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_effect_type_modifiers" TO "anon";
GRANT ALL ON TABLE "public"."fighter_effect_type_modifiers" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_effect_type_modifiers" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_effect_types" TO "anon";
GRANT ALL ON TABLE "public"."fighter_effect_types" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_effect_types" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_effects" TO "anon";
GRANT ALL ON TABLE "public"."fighter_effects" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_effects" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_equipment" TO "anon";
GRANT ALL ON TABLE "public"."fighter_equipment" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_equipment" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_equipment_selections" TO "anon";
GRANT ALL ON TABLE "public"."fighter_equipment_selections" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_equipment_selections" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_equipment_tradingpost" TO "anon";
GRANT ALL ON TABLE "public"."fighter_equipment_tradingpost" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_equipment_tradingpost" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_exotic_beasts" TO "anon";
GRANT ALL ON TABLE "public"."fighter_exotic_beasts" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_exotic_beasts" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_gang_legacy" TO "anon";
GRANT ALL ON TABLE "public"."fighter_gang_legacy" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_gang_legacy" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_injuries" TO "anon";
GRANT ALL ON TABLE "public"."fighter_injuries" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_injuries" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_skills" TO "anon";
GRANT ALL ON TABLE "public"."fighter_skills" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_skills" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_sub_types" TO "anon";
GRANT ALL ON TABLE "public"."fighter_sub_types" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_sub_types" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_type_equipment" TO "anon";
GRANT ALL ON TABLE "public"."fighter_type_equipment" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_type_equipment" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_type_gang_cost" TO "anon";
GRANT ALL ON TABLE "public"."fighter_type_gang_cost" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_type_gang_cost" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_type_gang_legacies" TO "anon";
GRANT ALL ON TABLE "public"."fighter_type_gang_legacies" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_type_gang_legacies" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_type_skill_access" TO "anon";
GRANT ALL ON TABLE "public"."fighter_type_skill_access" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_type_skill_access" TO "service_role";



GRANT ALL ON TABLE "public"."fighter_types" TO "anon";
GRANT ALL ON TABLE "public"."fighter_types" TO "authenticated";
GRANT ALL ON TABLE "public"."fighter_types" TO "service_role";
...
GRANT ALL ON TABLE "public"."gang_affiliation" TO "anon";
GRANT ALL ON TABLE "public"."gang_affiliation" TO "authenticated";
GRANT ALL ON TABLE "public"."gang_affiliation" TO "service_role";



GRANT ALL ON TABLE "public"."gang_logs" TO "anon";
GRANT ALL ON TABLE "public"."gang_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."gang_logs" TO "service_role";



GRANT ALL ON TABLE "public"."gang_origin_categories" TO "anon";
GRANT ALL ON TABLE "public"."gang_origin_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."gang_origin_categories" TO "service_role";



GRANT ALL ON TABLE "public"."gang_origins" TO "anon";
GRANT ALL ON TABLE "public"."gang_origins" TO "authenticated";
GRANT ALL ON TABLE "public"."gang_origins" TO "service_role";



GRANT ALL ON TABLE "public"."gang_stash" TO "anon";
GRANT ALL ON TABLE "public"."gang_stash" TO "authenticated";
GRANT ALL ON TABLE "public"."gang_stash" TO "service_role";



GRANT ALL ON TABLE "public"."gang_types" TO "anon";
GRANT ALL ON TABLE "public"."gang_types" TO "authenticated";
GRANT ALL ON TABLE "public"."gang_types" TO "service_role";



GRANT ALL ON SEQUENCE "public"."gang_types_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."gang_types_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."gang_types_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."gang_variant_types" TO "anon";
GRANT ALL ON TABLE "public"."gang_variant_types" TO "authenticated";
GRANT ALL ON TABLE "public"."gang_variant_types" TO "service_role";



GRANT ALL ON TABLE "public"."gangs" TO "anon";
GRANT ALL ON TABLE "public"."gangs" TO "authenticated";
GRANT ALL ON TABLE "public"."gangs" TO "service_role";
...
GRANT ALL ON TABLE "public"."trading_post_equipment" TO "anon";
GRANT ALL ON TABLE "public"."trading_post_equipment" TO "authenticated";
GRANT ALL ON TABLE "public"."trading_post_equipment" TO "service_role";



GRANT ALL ON TABLE "public"."trading_post_types" TO "anon";
GRANT ALL ON TABLE "public"."trading_post_types" TO "authenticated";
GRANT ALL ON TABLE "public"."trading_post_types" TO "service_role";
...
GRANT ALL ON TABLE "public"."weapon_profiles" TO "anon";
GRANT ALL ON TABLE "public"."weapon_profiles" TO "authenticated";
GRANT ALL ON TABLE "public"."weapon_profiles" TO "service_role";

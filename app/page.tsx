...
export default async function Home() {
  ...
  console.log(
    `Page rendering with ${gangs.length} gangs and ${campaigns.length} campaigns`
  );
            ...
            <div>
              <div className="flex gap-2">
                <a
                  ...
                  className="flex justify-center items-center px-2 py-1 text-sm rounded-md hover:bg-muted w-full"
                >
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <div className="flex-1 min-w-[135px] sm:w-auto w-full">
                  <CreateCampaignButton
                    initialCampaignTypes={campaignTypes}
                    userId={user.id}
                  />
                </div>
              </div>

...
// Note: delete actions moved to app/actions/delete-equipment.ts
...
// Stash delete and fighter delete actions are now in app/actions/delete-equipment.ts
...
// Note: delete actions have been moved to './delete-equipment'.
// Import them directly from that file where needed.

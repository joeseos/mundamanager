      ...
      <div className="mt-6">
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            disabled={!userPermissions.canEdit || (!fighter?.killed && (fighter?.retired || fighter?.enslaved || fighter?.captured || fighter?.recovery))}
            title={!fighter?.killed && (fighter?.retired || fighter?.enslaved || fighter?.captured || fighter?.recovery) ? 'Cannot kill: fighter is retired, enslaved, captured, or in recovery' : undefined}
          >
          ...
          <Button
            ...
            disabled={!userPermissions.canEdit || (!fighter?.retired && (fighter?.killed || fighter?.enslaved || fighter?.captured || fighter?.recovery))}
            title={!fighter?.retired && (fighter?.killed || fighter?.enslaved || fighter?.captured || fighter?.recovery) ? 'Cannot retire: fighter is killed, enslaved, captured, or in recovery' : undefined}
          >
          ...
          <Button
            ...
            disabled={!userPermissions.canEdit || (!fighter?.enslaved && (fighter?.killed || fighter?.retired || fighter?.captured || fighter?.recovery))}
            title={!fighter?.enslaved && (fighter?.killed || fighter?.retired || fighter?.captured || fighter?.recovery) ? 'Cannot sell to guilders: fighter is killed, retired, captured, or in recovery' : undefined}
          >
          ...
          {!fighter?.is_spyrer && (
            <Button
              ...
              disabled={!userPermissions.canEdit || fighter?.killed || fighter?.enslaved || fighter?.retired || fighter?.captured}
              title={fighter?.killed || fighter?.enslaved || fighter?.retired || fighter?.captured ? 'Cannot send to recovery: fighter is killed, enslaved, retired, or captured' : undefined}
            >
          ...
          {!fighter?.is_spyrer && (
            <Button
              ...
              disabled={!userPermissions.canEdit || (!fighter?.captured && (fighter?.killed || fighter?.retired || fighter?.enslaved || fighter?.recovery))}
              title={!fighter?.captured && (fighter?.killed || fighter?.retired || fighter?.enslaved || fighter?.recovery) ? 'Cannot capture: fighter is killed, retired, enslaved, or in recovery' : undefined}
            >

...
\restrict 9OWbUDEAf77K5QC0ylsrCohExInVT8jg4QnZX0wdfIX8OBmykO7vsasbZEjyLPk
...
--
-- Name: assign_crew_to_vehicle(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.assign_crew_to_vehicle(p_vehicle_id uuid, p_fighter_id uuid) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    old_vehicle jsonb;
...
--
-- Name: fighter_logs(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fighter_logs() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    gang_id_val UUID;
...
--
-- Name: repair_vehicle_damage(uuid[], integer, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.repair_vehicle_damage(damage_ids uuid[], repair_cost integer, in_user_id uuid) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'auth', 'private'
    AS $$
DECLARE
...
--
-- Name: vehicle_logs(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.vehicle_logs() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    vehicle_name TEXT;
...
--
-- Name: fighters fighter_delete_log_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER fighter_delete_log_trigger BEFORE DELETE ON public.fighters FOR EACH ROW EXECUTE FUNCTION public.fighter_logs();
...
--
-- Name: vehicles vehicle_log_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER vehicle_log_trigger AFTER INSERT OR DELETE OR UPDATE ON public.vehicles FOR EACH ROW EXECUTE FUNCTION public.vehicle_logs();
...
\unrestrict 9OWbUDEAf77K5QC0ylsrCohExInVT8jg4QnZX0wdfIX8OBmykO7vsasbZEjyLPk
